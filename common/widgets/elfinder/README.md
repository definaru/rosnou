...
'controllerMap' => [
        'elfinder' => [
            'class' => 'common\widgets\elfinder\Controller',
            ...
            'roots' => [
                ...
                [
                    'class' => 'common\widgets\elfinder\UserPath',
                    'path'  => 'files/user_{id}',
                    'name'  => 'My Documents'
                ],
                [
...
'controllerMap' => [
        'elfinder' => [
			'class' => 'common\widgets\elfinder\PathController',
			'access' => ['@'],
			'root' => [
				'path' => 'files',
				'name' => 'Files'
...
common\widgets\elfinder\Assets::noConflict($this);
