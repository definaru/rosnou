  ...
  var self = this,
    ...
    this.showCommonSizeError = function(files){
        ...
        this.error('Вы загружаете файлы с недопустимым размером ' +
                   ...
                   'Пожалуйста, воспользуйтесь внешним ресурсом для загрузки указанных файлов.');
    };
  ...
  */
  ...
  this.upload = function(files) {
        ...
        if(files) {
            ...
            // Если задано ограничение и привышено, выдаем предупреждение
            ...
            // Если задан максимальный размер и имеются файлы на вхде
