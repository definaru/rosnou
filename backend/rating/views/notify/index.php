 ...
 * @var common\models\NotifySearch $searchModel
 */
...
<div class="notify-index">
    ...
    <p>
        <?php /* echo Html::a('Create Notify', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
    ...
    <?php /*Pjax::begin();*/ echo GridView::widget([
        ...
        'columns' => [
            ...
            'id',
            'title',
            ['attribute'=>'finish_datetime','format'=>['datetime']],
            [
