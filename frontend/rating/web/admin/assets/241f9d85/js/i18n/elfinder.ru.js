...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.ru = {
		...
		messages   : {
			...
			'confirmRm'       : '<b>Будьте осторожны!</b><br>Если выбранные изображения или документы используются на сайте, после удаления они станут не доступны для просмотра и загрузки посетителями.<br>Действие необратимо!',
			'confirmMove'     : '<b>Будьте осторожны!</b><br>Если выбранные изображения или документы используются на сайте, после перемещения они станут не доступны для просмотра и загрузки посетителями.',

			'confirmRename'   : '<b>Будьте осторожны!</b><br>Если файл или файлы из директории используются на сайте, после переименования они станут не доступны для просмотра и загрузки посетителями.',
